...
PyAPI_FUNC(PyObject *) Py_ImportBuiltin(const char* name);
PyAPI_FUNC(PyObject *) Py_ReloadModule(const char* name);
PyAPI_FUNC(PyObject *) PyImport_AddModule(const char* name);

// Returns __builtin__
#define Py_GetBuiltinModule() \
    Py_ImportBuiltin((char*)"__builtin__")
