...
{
    PyErr_SetString(PyExc_RuntimeError, "compile disabled");
    return NULL;
}
...
{
    PyErr_SetString(PyExc_RuntimeError, "execfile disabled");
    Py_RETURN_NONE;
}
...
{
    PyErr_SetString(PyExc_RuntimeError, "builtin_input disabled");
    Py_RETURN_NONE;
}
...
builtin_reduce(PyObject *self, PyObject *args)
{
    ...
    if (functools_reduce == NULL) {
        PyObject *functools = Py_ImportBuiltin("_functools");
        if (functools == NULL)
            return NULL;
